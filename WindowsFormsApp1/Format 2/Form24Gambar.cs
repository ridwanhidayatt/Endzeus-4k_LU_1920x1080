...
namespace WindowsFormsApp1.Format_2
{
    public partial class Form24Gambar : Form
    {
        ...
        public event TransfDelegate TEViewC41Gambar;
        public event TransfDelegate TEViewC42Gambar;
        public event TransfDelegate TEViewC46Gambar;
        public event TransfDelegate TEClose4Gambar;
        public event TransfDelegate TEViewC24G;
        ...
        private void InitializeMainPictureBoxes()
        {
            ...
            PictureBox[] pictureBoxes = { pictureBox1, pictureBox3, pictureBox4, pictureBox5 };
        ...
        // Metode untuk membersihkan gambar dari PictureBox
        ...
        // Metode untuk membersihkan ComboBox
        ...
        //    comboBox1.ResetText(); 
        //    int kondisi1 = 7;
        //    TEViewC46Gambar(kondisi1.ToString());
        //    this.Close();
        //} 
        ...
        private void FormCirebon4Gambar_Load(object sender, EventArgs e)
        {
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(pictureBox3.Image, 25, 479, 374, 212);
        ...
        private void printDocument12_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(pictureBox3.Image, 46, 479, 374, 212);
        ...
        private void printDocument2_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(pictureBox3.Image, new Rectangle(25, 479, 374, 212), 0, 0, pictureBox3.Image.Width, pictureBox3.Image.Height, GraphicsUnit.Pixel, ia);
            e.Graphics.DrawImage(pictureBox4.Image, new Rectangle(403, 262, 374, 212), 0, 0, pictureBox5.Image.Width, pictureBox5.Image.Height, GraphicsUnit.Pixel, ia);
            e.Graphics.DrawImage(pictureBox5.Image, new Rectangle(403, 479, 374, 212), 0, 0, pictureBox4.Image.Width, pictureBox4.Image.Height, GraphicsUnit.Pixel, ia);
            ia.Dispose();
        ...
        // Metode untuk mengatur ulang gambar dari PictureBox
        private void ResetPictures()
        {
            foreach (var pictureBox in new[] { pictureBox1, pictureBox3, pictureBox4, pictureBox5 })
            {
                ...
                {
                    pictureBox.Image.Dispose();
                    pictureBox.Image = Properties.Resources.icon; // Set gambar default
                }
            }
        }
        ...
        //    comboBox1.ResetText(); 
        //    int kondisi = 9;
        //    TEClose4Gambar(kondisi.ToString()); 
        //    this.Close(); 
        //}
        ...
        private void HandleButtonClick(int kondisi, TransfDelegate teViewMethod)
        {
            ResetPictures();
            ClearComboBox();
            teViewMethod(kondisi.ToString());
            this.Close();
        }

        // Event handler untuk button4
        private void button4_Click(object sender, EventArgs e)
        {
            HandleButtonClick(4, TEViewC41Gambar);
        }

        // Event handler untuk button1
        private void button1_Click(object sender, EventArgs e)
        {
            HandleButtonClick(5, TEViewC42Gambar);
        }
        ...
        //    comboBox1.ResetText(); 
        //    int kondisi1 = 4;
        //    TEViewC41Gambar(kondisi1.ToString()); 
        //    this.Close();
        //}
        ...
        //    comboBox1.ResetText(); 
        //    int kondisi1 = 5;
        //    TEViewC42Gambar(kondisi1.ToString()); 
        //    this.Close();
        //}

        private void timer1_Tick(object sender, EventArgs e)
        {
            // Update button visibility based on the presence of images
            UpdateButtonVisibility(pictureBox1, btn_Delete);
            UpdateButtonVisibility(pictureBox3, button9);
            UpdateButtonVisibility(pictureBox4, button11);
            UpdateButtonVisibility(pictureBox5, button6);

            // Enable/disable buttons based on multiple conditions
            bool isAllImagesPresent = pictureBox1.Image != null
                                    && pictureBox3.Image != null
                                    && pictureBox4.Image != null
                                    && pictureBox5.Image != null
                                    && picLogo1.Image != null;

            bool isTextFieldsFilled = !string.IsNullOrEmpty(richTextBox1.Text)
                                    && !string.IsNullOrEmpty(textBoxKlinis.Text);

            bool isFormComplete = isAllImagesPresent && isTextFieldsFilled;

            buttonExportPdf.Enabled = isFormComplete;
            buttonPrint.Enabled = isFormComplete;
            comboBox1.Enabled = isFormComplete;
        }

        // Helper method to update button visibility based on pictureBox's image
        private void UpdateButtonVisibility(System.Windows.Forms.PictureBox pictureBox, Button visibleButton)
        {
            bool hasImage = pictureBox.Image != null;
            visibleButton.Visible = !hasImage;
        }
        ...
        //    if (pictureBox1.Image != null && pictureBox3.Image != null && pictureBox4.Image != null && pictureBox5.Image != null && picLogo1.Image != null && richTextBox1.Text != "" && textBoxKlinis.Text != "")
        //    {
